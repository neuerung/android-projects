...
public class VideoGalleryBG extends AsyncTask<Void,Void,Void> {

	Context context;
	String forparser;
	ProgressDialog dialog;
	public VideoGalleryBG(Context context,String forparser) {
	...
	protected void onPreExecute() {
		...
		dialog.show();
		if(forparser.equals("VideoGalleryCategory"))
		{
			dialog.setMessage("Getting Video Category");
		}
	...
	protected void onPostExecute(Void result) {
		...
		try {
			if(forparser.equals("VideoGalleryCategory"))
			{
				((Home)context)._objUtilVideoGalleryCategory.SetAdapterForCategory(context);
			}
			else if(forparser.equals("PictureGalleryGrid"))
			{
