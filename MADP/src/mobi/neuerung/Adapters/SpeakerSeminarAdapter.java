...
public class SpeakerSeminarAdapter extends ArrayAdapter<SpeakerSeminarsWrapper>
{
	...
	public SpeakerSeminarAdapter(Context context,int textViewResourceId,ArrayList<SpeakerSeminarsWrapper> array) {
